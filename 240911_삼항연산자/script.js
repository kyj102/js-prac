...
const name = prompt("이름을 입력해주세요!");
const height= parseFloat(Number(prompt("키를 입력해주세요! ex.176.2")));
const weight= parseFloat(Number(prompt("체중을 입력해주세요! ex.45.2")));

const avrWeight = (height - 100) * 0.9;

console.log(`적정체중: ${avrWeight}`);
console.log(`입력한 체중: ${weight}`);

const result = (weight <= avrWeight + 5) && (weight <= avrWeight -5)
